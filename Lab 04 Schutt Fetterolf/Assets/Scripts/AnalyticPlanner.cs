...
public class AnalyticPlanner : MonoBehaviour
{
    ...
    public float defensiveArc = 180f;
    ...
    public float defensiveHitWeight = .45f;
    public float defensiveObsvWeight = .6f;
    public float defensiveCommWeight = .05f;
    ...
    public Dictionary<Int3, float> defensibleNodes = null;
    public Dictionary<Int3, float> defHitCost = null;
    public Dictionary<Int3, float> defCommCost = null;
    public Dictionary<Int3, float> defObsCost = null;
