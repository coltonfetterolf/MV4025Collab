...
public class AnalyticPlanner : MonoBehaviour
{
    ...
    public Dictionary<Int3, float> SE2positionCost = null;  // Based on observer count in reference to SE2
    public Dictionary<Int3, float> SE2pathCost = null;  // Cost to move to assault point in reference to SE2
    public Dictionary<Int3, float> SE2assaultDistCost = null;  // Distance from assault point to target in reference to SE2
    public List<GraphNode> SE2sectorNodes = null; // Nodes in consideration for SE2 sector choices
