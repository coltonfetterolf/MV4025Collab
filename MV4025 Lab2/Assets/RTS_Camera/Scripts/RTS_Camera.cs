    ...
    public class RTS_Camera : MonoBehaviour
    {
        ...
        private void HeightCalculation()
        {
            ...
            if (autoHeight)
                ...
                difference = targetHeight - m_Transform.position.y;

            //Debug.Log("distanceToGround: " + distanceToGround + " targetHeight: " + targetHeight + " difference: " + difference + " interp: " + Time.deltaTime * heightDampening);
            //Debug.Log("position before: " + m_Transform.position);
            ...
            //Debug.Log("position after: " + m_Transform.position);
        }
